...
def create_log_entry(payload: LogEntryCreate, db: Session = Depends(get_session)):
...
def read_log_entry(entry_id: int, db: Session = Depends(get_session)):
...
def list_log_entries(
    ...
    """List log entries with optional filters (plant, operator, type, time range)."""
